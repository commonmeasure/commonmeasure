---
description: Enrol the current project directory with Common Measure.
---
...
Use the plugin launcher `${CLAUDE_PLUGIN_ROOT}/bin/commonmeasure-launch` when
invoked through the Claude plugin. A managed pending request needs owner
