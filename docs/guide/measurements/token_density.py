...
def main():
    ...
    # ---- repository files, all committed and readable by anyone with the repo
    samples = [
        ("English prose (markdown)", "PRODUCT.md", ""),
        ("English prose (markdown, long)", "ROADMAP.md", ""),
        ...
        ("JSON Schema", "schema/telemetry-event.v0.1.json", "tool-definition shaped"),
        ("JSON (API-shaped record)", "demo/output/latest/summary.json", ""),
        ("NDJSON (event log)", "demo/output/latest/evidence.ndjson", ""),
