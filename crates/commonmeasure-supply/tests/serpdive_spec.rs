...
//! response shape.
//!
//! No recon capture of SERPdive is committed, so these tests need no
//! credential and exercise the parser over SERPdive's documented shapes
//! (`https://serpdive.com/docs`, read 18 August 2026) through the real
...
//! call would use. Only the origin is local: it stands in for the network,
