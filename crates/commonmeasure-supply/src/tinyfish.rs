...
//! wires the Search API alone and none of those capabilities; the posture, its
//! first-hand evidence and what it means for admission are recorded in
//! `docs/knowledge-base/supply-map.md`. "Crawler accessibility is not
