...
/// 1 August 2026: none returns a licence, rights or author field. An adapter
/// never infers permission from the fact that a crawler could reach the page,
/// so there is deliberately no variant meaning "probably fine".
