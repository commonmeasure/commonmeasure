...
//! licence or from the operator's terms, never from here. Discovery
//! therefore never delays a crossing and is written as its own record kind,
//! so a probe can never project as a retrieval.
//!
