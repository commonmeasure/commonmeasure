...
//!
//! The fixture (`tests/fixtures/cited-run-2026-08-04.json`, see the README
//! beside it) carries the four real model answers byte for byte, the window
//! parts as `ContextPart` fields in order, and the verdicts grounding 0.3.0
//! published — wrong reasons and all. The `published_evaluation` documents
...
fn fixture() -> Value {
    let path = std::path::Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("tests/fixtures/cited-run-2026-08-04.json");
