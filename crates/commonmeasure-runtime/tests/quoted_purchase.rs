...
//! captures of 4 August 2026 (`demo/recon/redpine/`) — the substitution every
...
/// is register R5). Every other leg serves the recorded bytes.
...
fn a_trial_covered_purchase_completes_with_the_quote_in_evidence_before_the_receipt() {
    ...
    // explicitly unknown licence (register R4).
