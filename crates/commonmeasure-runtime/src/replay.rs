...
//! integration tests make (`crates/commonmeasure-supply/tests/recorded_replay.rs`), and
//! the only one `AGENTS.md` permits. What replay adds over the tests is
//! provenance: a committed manifest names each served response's recon
