...
//!
//! Everything here is deterministic and runs inside this binary. Sidecar and
//! remote processors remain contract-only (`ROADMAP.md` P3): nothing in this
//! module opens a socket, reads a file or holds a credential, and the
//! manifests say so.
...
pub struct Implementation {
    /// `in-process` today. Sidecar and remote implementations are contract
    /// states, not code (`docs/contracts/processor.md`).
    pub kind: &'static str,
