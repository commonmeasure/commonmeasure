...
//!
//! Two operations, recorded separately as the knowledge base requires
//! (`docs/knowledge-base/open-source-landscape.md`, "Context-window
//! optimisation"): whole-source deduplication and repeated-phrase
//! deduplication. Ordering is the provider's retrieval order, preserved and
