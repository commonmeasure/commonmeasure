...
const BLIND_SPOTS: &[&str] = &[
    ...
    "The exchange's charge in currency is unknown: the gateway reports tokens and no price.",
];
...
pub fn invoke(
    ...
    Invocation::new(
        ...
        json!({
            ...
            "cost": {
                "money": Value::Null,
                "note": "the gateway reports tokens and no price; the charge in currency is \
                         unknown",
            },
