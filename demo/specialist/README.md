...
The committed runs live under `demo/output/specialist/` and are regenerated
with the gateway up:
...
```sh
jq -r .hash demo/output/specialist/revocation-pre/manifest.json demo/output/specialist/revocation-post/manifest.json
commonmeasure inspect demo/output/specialist/revocation-post
```
