...
clearance — and the delivered bytes on disk are that claim's evidence. The
oa-server integration's own verification state is recorded in
docs/knowledge-base/unverified-assumptions.md, not asserted here.
